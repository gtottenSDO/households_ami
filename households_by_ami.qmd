...
if (drive_check_local(ipums_files, ipums_dir)) {
  acs_data <- read_ipums_ddi(ipums_ddi) |>
    read_ipums_micro()
} else {
  drive_download(ipums_files, ipums_dir, project_folder = "households_by_ami")
  if (drive_check_local(ipums_files, ipums_dir)) {
    acs_data <- read_ipums_ddi(ipums_ddi) |>
      read_ipums_micro()
  } else {
    ...
    drive_upload(ipums_files, ipums_dir, project_folder = "households_by_ami")
  }
}
```
